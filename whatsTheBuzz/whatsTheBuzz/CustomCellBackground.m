...
//  whatsTheBuzz
//
//  Created by Keaton Swoboda on 5/7/15.
...
- (void)drawRect:(CGRect)rect
{
    ...
    UIColor *lightGradientColor = [UIColor colorWithRed:1 green:1 blue:0.8 alpha:1.0];
    UIColor *darkGradientColor = [UIColor colorWithRed:1 green:1 blue:0.3 alpha:1.0];
