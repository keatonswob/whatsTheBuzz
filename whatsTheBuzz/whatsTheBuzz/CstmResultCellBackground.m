//
//  CstmResultCellBackground.m
//  whatsTheBuzz
//
//  Created by Keaton Swoboda on 5/12/15.
//  Copyright (c) 2015 The Iron Yard. All rights reserved.
//

#import "CstmResultCellBackground.h"

@implementation CstmResultCellBackground
...
- (void)drawRect:(CGRect)rect
{
    ...
    UIColor *darkGradientColor = [UIColor colorWithRed:1 green:1 blue:0.5 alpha:1.0];
